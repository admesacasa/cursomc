...
import com.nelioalves.cursomc.services.exceptions.StandarError;
...
public class ResourceExceptionHandler{
	...
	public ResponseEntity<StandarError> dateIntegrityException(DateIntegrityException e, HttpServletRequest request) {
